  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          // La marge latérale du mobile est exprimée en largeur, pas en largeur
          // maximale : `max-w-[calc(100%-2rem)]` entrait en concurrence avec le
          // `sm:max-w-*` passé par l'appelant, et l'emportait — tous les
          // dialogues s'affichaient alors larges comme la fenêtre, quelle que
