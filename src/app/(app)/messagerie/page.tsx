...
import { errorMessage, fileUrl, messagingApi } from "@/lib/api";
    ...
    <div className="-mx-4 -mt-5 flex h-[calc(100dvh-3.5rem)] sm:-mx-6 lg:-mx-8">
      ...
      >
        <header className="flex h-14 shrink-0 items-center justify-between gap-2 border-b px-3">
          ...
          <NewConversationDialog onStarted={setActiveId} />
        </header>
          ...
          {isLoading ? (
            ...
            <div className="p-4">
              <EmptyState
                ...
                description="Écrivez à l'équipe ou à une structure : les réponses arrivent ici."
              />
            </div>
          ) : (
            <ul className="p-2">
